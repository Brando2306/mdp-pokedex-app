...
class PokemonPaginatedResponse {
    ...
    factory PokemonPaginatedResponse.fromJson(Map<String, dynamic> json) => PokemonPaginatedResponse(
        ...
        results: List<PokemonResult>.from(json["results"].map((x) => PokemonResult.fromJson(x))),
    );
...
PokemonFull pokemonFullFromJson(String str) => PokemonFull.fromJson(json.decode(str));

String pokemonFullToJson(PokemonFull data) => json.encode(data.toJson());
...
class PokemonFull {
    ...
    factory PokemonFull.fromJson(Map<String, dynamic> json) => PokemonFull(
